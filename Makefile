...
caluma-dump-forms: ## dump Caluma form models
	...
	caluma_form.QuestionOption caluma_form.Option | sed -e 's/\r$$//' > caluma/data/form-config.json
...
caluma-dump-workflow: ## dump Caluma workflow models
	...
	caluma_workflow.TaskFlow | sed -e 's/\r$$//' > caluma/data/workflow-config.json
