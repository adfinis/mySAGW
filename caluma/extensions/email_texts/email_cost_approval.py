...
After a careful review your application we are pleased to inform you that a framework credit of {framework_credit} has been approved for the project mentioned below.
...
Wir haben Ihren Antrag geprüft und freuen uns, Ihnen mitteilen zu können, dass wir für das unten genannte Projekt einen Rahmenkredit von {framework_credit} gesprochen haben.
...
Nous avons examiné votre demande et avons le plaisir de vous informer que nous avons accordé un crédit-cadre de {framework_credit} pour le projet mentionné ci-dessous.
